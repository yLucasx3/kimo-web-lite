						...
						<div className="customer-address">
							...
							{!mainAddress && !selectedAddress &&
								<span
									...
									onClick={() => !isAuthenticated ? setShowSignInUp(true) : router.push('profile/create-address/return')}>
									Criar endereço
								</span>
							}
						</div>
									...
									<div className="product-info">
										...
										<div className="quantity-products">
											...
											<div className="quantity-buttons">
												<button onClick={() => {
													if (!isAuthenticated) return changeQuantityStored(customerBag.id, customerBag.quantity - 1);
