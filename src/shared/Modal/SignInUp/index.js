...
const SignInUp = ({ isOpen, handleClose, defaultIsSignIn }) => {
    ...
    const doLogin = async e => {
        ...
        if (response && response.success) router.push('/profile/account');
    ...
    return (
        <BaseModal isOpen={isOpen} handleClose={handleClose} withBorder isTopScreen={isTopScreen} requestClose>
