    ...
    return (
        <Container>
            ...
            <div className="filter-search">
                ...
                <button>
                    <Image src={SearchIcon} width="16px" alt="Lupa de busca" />
                </button>
            </div>
            <div className="filter">
                <label className="item-filter" htmlFor="camiseta">
                    ...
                    <label className="title-filter-item" htmlFor="camiseta">
                        Camiseta
                    </label>
                </label>
                ...
                <label className="item-filter" htmlFor="moletom">
                    ...
                    <label className="title-filter-item" htmlFor="moletom">
                        Moletom
                    </label>
                </label>
                ...
                <label className="item-filter" htmlFor="acessorios">
                    ...
                    <label className="title-filter-item" htmlFor="acessorios">
                        Acessório
                    </label>
                </label>
                ...
                <label className="item-filter" htmlFor="canecas">
                    ...
                    <label className="title-filter-item" htmlFor="canecas">
                        Caneca
                    </label>
                </label>
                ...
                <label className="item-filter" htmlFor="diversos">
                    ...
                    <label className="title-filter-item" htmlFor="diversos">
                        Diversos
                    </label>
                </label>
                ...
                <label className="item-filter" htmlFor="outros">
                    ...
                    <label className="title-filter-item" htmlFor="outros">
                        Outros
                    </label>
                </label>
            </div>
