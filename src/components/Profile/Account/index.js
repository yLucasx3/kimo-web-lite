...
const Account = () => {
    ...
    const updateCustomer = async () => {
        if (
            customer.firstName !== defaultCustomer.firstName ||
        ...
        <>
            {user && customer && (
                <Container>
                    ...
                    >
                        {isEditable ? <Image src={CheckedIcon} alt="" /> : <Image src={EditIconWhite} alt="" />}
                    </button>
                </Container>
            )}
        </>
